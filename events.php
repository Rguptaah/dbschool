...
<head>
    <!-- meta tag -->
    <meta charset="utf-8">
    <title>Events | <?php echo $full_name; ?></title>
    <!-- Breadcrumbs Start -->
                ...
                <div class="col-lg-6 col-md-12 md-mb-30">
                    <div class="event-item">
                        <div class="row rs-vertical-middle">
                            <div class="col-md-6">
                                <div class="event-img">
                                    <img src="assets/images/events/4.jpg" alt="events Images" />
                                    <a class="image-link" href="events-details" title="School Tour">
                            ...
                            <div class="col-md-6">
                                <div class="event-content">
                                    ...
                                    <h3 class="event-title"><a href="events-details">Freshers Day reception <br>ceremony 2017</a></h3>
                                    ...
                                    <div class="event-btn">
                                        <a href="events-details">Join Event</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="event-item">
                        <div class="row rs-vertical-middle">
                            <div class="col-md-6">
                                <div class="event-img">
                                    <img src="assets/images/events/5.jpg" alt="events Images" />
                                    <a class="image-link" href="assets/images/events/kids1" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-12 md-mb-30">
                    <div class="event-item">
                        <div class="row rs-vertical-middle">
                            <div class="col-md-6">
                                <div class="event-img">
                                    <img src="assets/images/events/6.jpg" alt="events Images" />
                                    <a class="image-link" href="events-details" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
                                </div>
                            </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="event-item">
                        <div class="row rs-vertical-middle">
                            <div class="col-md-6">
                                <div class="event-img">
                                    <img src="assets/images/events/7.jpg" alt="events Images" />
                                    <a class="image-link" href="events-details" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
                                </div>
                ...
                <div class="col-lg-6 col-md-12 md-mb-30">
                    <div class="event-item">
                        <div class="row rs-vertical-middle">
                            <div class="col-md-6">
                                <div class="event-img">
                                    <img src="assets/images/events/8.jpg" alt="events Images" />
                                    <a class="image-link" href="events-details" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
                                </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="event-item">
                        <div class="row rs-vertical-middle">
                            <div class="col-md-6">
                                <div class="event-img">
                                    <img src="assets/images/events/9.jpg" alt="events Images" />
                                    <a class="image-link" href="events-details" title="University Tour 2018">
                                        <i class="fa fa-link"></i>
                                    </a>
                                </div>
    ...
    <!-- <div id="rs-branches" class="rs-branches sec-color pt-100 pb-70">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="branches-item">
                        <img src="assets/images/about/china.png" alt="China Flag">
                        <h3>
                            <span>02</span>
                            China
                        </h3>
    ...
    <!-- Partner Start -->
    <!-- <div id="rs-partner" class="rs-partner pt-70 pb-170">
        <div class="container">
