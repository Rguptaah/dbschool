    ...
    <div id="rs-slider" class="slider-overlay-2">
        <div id="home-slider" class="rs-carousel owl-carousel" data-loop="true" data-items="4" data-margin="0" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="false" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="1" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="1" data-md-device-nav="true" data-md-device-dots="false">
            ...
            <div class="item active">
                <img src="assets/images/slider/home1/slide1.jpg" alt="Slide1" />
                <div class="slide-content">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="container text-center">
                                <h1 class="slider-title" data-animation-in="fadeInLeft" data-animation-out="animate-out">WELCOME TO <?php echo $full_name; ?></h1>
                                <p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">We at Don Bosco endeavour to optimize their creative and adventurous spirit<br class="hidden-sm-dow"> by providing them avenues of creativity, adventure and sport activities.</p>
            ...
            <!-- Item 2 -->
            <div class="item">
                <img src="assets/images/slider/home1/slide2.jpg" alt="Slide2" />
                <div class="slide-content">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="container text-center">
                                <h1 class="slider-title" data-animation-in="fadeInUp" data-animation-out="animate-out">ARE YOU READY TO APPLY?</h1>
                                <p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">We are at the right place to brighten the future of children.<br class="hidden-sm-dow"> Hurry! up for the registration and apply now.</p>
            ...
            <!-- Item 3 -->
            <div class="item">
                <img src="assets/images/slider/home1/slide3.jpg" alt="Slide3" />
                <div class="slide-content">
                    <div class="display-table">
                        <div class="display-table-cell">
                            <div class="container text-center">
                                <h1 class="slider-title" data-animation-in="fadeInUp" data-animation-out="animate-out">OUR FEATURES</h1>
                                <p data-animation-in="fadeInUp" data-animation-out="animate-out" class="slider-desc">We are providing high quality studies for every student of our school.<br> Brighten the future of your child at our own risk.</p>
                                <a href="#" class="sl-readmore-btn mr-30" data-animation-in="fadeInUp" data-animation-out="animate-out">READ MORE</a>
                                <a href="#" class="sl-get-started-btn" data-animation-in="fadeInUp" data-animation-out="animate-out">GET STARTED NOW</a>
                            </div>
                        </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="services-item rs-animation-hover">
                        ...
                        <div class="services-desc">
                            <h4 class="services-title">Computer Lab</h4>
                            <p>Well Maintained Computers with latest OS embedded inside a separate room</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="services-item rs-animation-hover">
                        ...
                        <div class="services-desc">
                            ...
                            <p>Lots of books available for rent and higher resource at low cost.</p>
                            <br>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="services-item rs-animation-hover">
                        ...
                        <div class="services-desc">
                            ...
                            <p>They are certified with high skills and experienced in their respective field.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="services-item rs-animation-hover">
                        ...
                        <div class="services-desc">
                            ...
                            <p>We are certified by high post person for high qaulity studies.</p>
                            <br>
                        </div>
                    </div>
                </div>
    ...
    <div id="rs-about" class="rs-about sec-spacer">
        <div class="container">
            <div class="sec-title mb-50 text-center">
                <h2>ABOUT US</h2>
                <p>Don Bosco School is an ideal school in the city of Siwan. The School has a rich heritage of above 25 years in terms of presence and is powered by deep rooted Indian values and rich culture. We aspire to equip our students with skills that will help them excel in life and prepare for their greater role of shaping the Indian Millennium tomorrow. </p>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="about-img rs-animation-hover">
                        <img src="assets/images/about/about.jpg" alt="img02" />
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="about-desc">
                        <h3>WELCOME TO <?php echo $full_name; ?></h3>
                        <p>We are among the Top 5 Progressive Schools in state with a distinctive pedagogy and a special focus on modern sports and holistic development. The ultra modern campus has been sports facilities like Lawn Tennis, Table Tennis Skating and Cricket considering the fitness and mental health of child. </p>
                    </div>
                    <div id="accordion" class="rs-accordion-style1">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-bs-parent="#accordion">
                                <div class="card-body">
                                    The School is accredited to British Council (2021-23) and a front runner in technology. We also are the leaders in providing a huge self managed fleet of School Transport which covers almost every corner of the town.
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-bs-parent="#accordion">
                                <div class="card-body">
                                    <ul>
                                        <li>To become the most progressive school in state.</li>
                                        <li>To fulfill all needs of the student for new trend.</li>
                                        <li>To create a new way to deliver education in a simple way.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-bs-parent="#accordion">
                                <div class="card-body">
                                    <ul>
                                        <li>Develop Socially Responsible Citizens by teaching to treat people, places and things with Kindness.</li>
                                        <li>Enable students to become innovative, self-driven and self-sustainable through entrepreneur mindset development.</li>
                                        <li>Provide quality education through technology solutions for life-long learning. </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="counter-content">
                        ...
                        <div class="counter-img rs-image-effect-shine">
                            <img src="assets/images/counter/1.jpg" alt="Counter Discussion">
                        </div>
                    </div>
                </div>
    ...
    <div id="rs-team" class="rs-team sec-color sec-spacer">
        <div class="container">
            <div class="sec-title mb-50 text-center">
                ...
                <p>We have experienced and skilled faculty for bright future of student</p>
            </div>
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="false" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="3" data-md-device-nav="true" data-md-device-dots="true">
                <div class="team-item">
                    <div class="team-img">
                ...
                <div class="col-md-12">
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="2" data-margin="30" data-autoplay="true" data-autoplay-timeout="5000" data-smart-speed="1200" data-dots="true" data-nav="true" data-nav-speed="false" data-mobile-device="1" data-mobile-device-nav="true" data-mobile-device-dots="true" data-ipad-device="2" data-ipad-device-nav="true" data-ipad-device-dots="true" data-md-device="2" data-md-device-nav="true" data-md-device-dots="true">
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="assets/images/testimonial/1.jpg" alt="Jhon Smith">
                            </div>
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="assets/images/testimonial/2.jpg" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="assets/images/testimonial/3.jpg" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                                <h4 class="testi-name">Aliana D’suza</h4>
                                <p>
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="assets/images/testimonial/4.jpg" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                                <h4 class="testi-name">Aliana D’suza</h4>
                                <p>
                        ...
                        <div class="testimonial-item">
                            <div class="testi-img">
                                <img src="assets/images/testimonial/5.jpg" alt="Jhon Smith">
                            </div>
                            <div class="testi-desc">
                                <h4 class="testi-name">Aliana D’suza</h4>
                                <p>
